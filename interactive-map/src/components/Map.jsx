...
const Map = () => {
  ...
  const facilities = [
    { id: 1, name: '중앙도서관', coordinates: [37.584939, 127.062061], description: 'Main Library' },
    { id: 2, name: '학생회관', coordinates: [37.583670, 127.059945], description: 'Student Hall' },
  ];
  ...
  return (
    <MapContainer center = {campusCoordinates} zoom = {zoomLevel} style = {{ height: '90dvh', width: '100%' }}>
